...
# 134 "MCAL_layer/gpio/gpio.c"
logic_t digitalRead(port_t Portx, pin_t Pinx) {
    logic_t level = LOW;
    switch (Portx) {
        case PA:
            level = ((PORTA >> Pinx) & 1) ? HIGH : LOW;
            break;
        case PB:
            level = ((PORTB >> Pinx) & 1) ? HIGH : LOW;
            break;
        case PC:
            level = ((PORTC >> Pinx) & 1) ? HIGH : LOW;
            break;
        case PD:
            level = ((PORTD >> Pinx) & 1) ? HIGH : LOW;
            break;
        case PE:
            level = ((PORTE >> Pinx) & 1) ? HIGH : LOW;
            break;
        default:
            break;
    }
...
# 166 "MCAL_layer/gpio/gpio.c"
void togglePin(port_t Portx, pin_t Pinx){
    switch (Portx) {
        case PA:
            (PORTA ^= (1 << Pinx)) ? HIGH : LOW;
            break;
        case PB:
            (PORTB ^= (1 << Pinx)) ? HIGH : LOW;
            break;
        case PC:
            (PORTC ^= (1 << Pinx)) ? HIGH : LOW;
            break;
        case PD:
            (PORTD ^= (1 << Pinx)) ? HIGH : LOW;
            break;
        case PE:
            (PORTE ^= (1 << Pinx)) ? HIGH : LOW;
            break;
        default:
            break;
    }
