...
# 1 "MCAL_layer/spi/../../MCAL_Layer/gpio/gpio.h" 1
# 14 "MCAL_layer/spi/../../MCAL_Layer/gpio/gpio.h"
# 1 "MCAL_layer/spi/../../MCAL_Layer/gpio/../../MCAL_layer/device_config.h" 1
# 14 "MCAL_layer/spi/../../MCAL_Layer/gpio/gpio.h" 2

# 1 "MCAL_layer/spi/../../MCAL_Layer/gpio/gpio_cfg.h" 1
# 15 "MCAL_layer/spi/../../MCAL_Layer/gpio/gpio.h" 2
...
# 56 "MCAL_layer/spi/../../MCAL_Layer/gpio/gpio.h"
...
# 1 "MCAL_layer/spi/../../MCAL_layer/adc/hal_adc.h" 1
# 16 "MCAL_layer/spi/../../MCAL_layer/adc/hal_adc.h"
# 1 "MCAL_layer/spi/../../MCAL_layer/adc/hal_adc_cfg.h" 1
# 16 "MCAL_layer/spi/../../MCAL_layer/adc/hal_adc.h" 2
...
# 116 "MCAL_layer/spi/../../MCAL_layer/adc/hal_adc.h"
...
static void (*SPI_Report_Write_Collision_InterruptHandler)(void) = (0);
static void (*SPI_Report_Receive_Overflow_InterruptHandle)(void) = (0);
static void (*SPI_DefaultInterruptHandle)(void) = (0);
...
static __attribute__((inline)) void set_spi_mode(uint8 mode);
static __attribute__((inline)) void MSSP_SPI_Interrupt_Configurations(void (*InterruptHandler)(void));
...
void HAL_SPI_Init(uint8 mode){
    ...
    if(mode == 0X04 || mode == 0X05)
    {
        ...
        pinMode(PC,PIN5,OUTPUT);
        (ADCON1bits.PCFG = ADC_AN1_AN3_ANALOG_VREF_NOT);
        pinMode(PA,PIN5,INPUT);
    }
    else
    {
        pinMode(PC,PIN3,OUTPUT);
        pinMode(PC,PIN4,INPUT);
        pinMode(PC,PIN5,OUTPUT);
    }
...
static __attribute__((inline)) void set_spi_mode(uint8 mode)
{
    switch(mode)
    {
        case 0x00 : (SSPCONbits.SSPM = 0x00);break;
        case 0x01 : (SSPCONbits.SSPM = 0x01);break;
        case 0x02 : (SSPCONbits.SSPM = 0x02);break;
        case 0x03 : (SSPCONbits.SSPM = 0x03);break;
        case 0X04 : (SSPCONbits.SSPM = 0X04);break;
        case 0X05 : (SSPCONbits.SSPM = 0X05);break;
        default : break;
    }
}
static __attribute__((inline)) void MSSP_SPI_Interrupt_Configurations(void (*InterruptHandler)(void))
