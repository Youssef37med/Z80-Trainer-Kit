...
# 1 "MCAL_layer/usart/../../MCAL_Layer/gpio/gpio.h" 1
# 14 "MCAL_layer/usart/../../MCAL_Layer/gpio/gpio.h"
# 1 "MCAL_layer/usart/../../MCAL_Layer/gpio/../../MCAL_layer/device_config.h" 1
# 14 "MCAL_layer/usart/../../MCAL_Layer/gpio/gpio.h" 2

# 1 "MCAL_layer/usart/../../MCAL_Layer/gpio/gpio_cfg.h" 1
# 15 "MCAL_layer/usart/../../MCAL_Layer/gpio/gpio.h" 2
...
# 56 "MCAL_layer/usart/../../MCAL_Layer/gpio/gpio.h"
...
# 9 "MCAL_layer/usart/hal_usart.c" 2




    static void (*EUSART_TxInterruptHandler)(void) = (0);


    static void (*EUSART_RxInterruptHandler)(void) = (0);
    static void (*EUSART_FramingErrorHandler)(void) = (0);
    static void (*EUSART_OverrunErrorHandler)(void) = (0);
...
static void USART_Baud_Rate_Calculation(uint32 baud)
{
    ...
    {
        (TXSTAbits.BRGH = 0);
        Baud_Rate_Temp = (16000000 - baud*64)/(baud*64);
    }
    else if (baud > 2400)
    {
        (TXSTAbits.BRGH = 1);
        Baud_Rate_Temp = (16000000 - baud*16)/(float)(baud*16);
    }
...
void EUSART_RX_ISR(void)
{
    ...
    if(EUSART_FramingErrorHandler && (FERR == 1)){
        EUSART_FramingErrorHandler();
    }else { }
    if(EUSART_OverrunErrorHandler && (OERR == 1)){
