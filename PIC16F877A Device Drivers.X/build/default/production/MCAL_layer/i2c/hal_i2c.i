...
# 1 "MCAL_layer/i2c/../../MCAL_Layer/gpio/gpio.h" 1
# 14 "MCAL_layer/i2c/../../MCAL_Layer/gpio/gpio.h"
# 1 "MCAL_layer/i2c/../../MCAL_Layer/gpio/../../MCAL_layer/device_config.h" 1
# 14 "MCAL_layer/i2c/../../MCAL_Layer/gpio/gpio.h" 2

# 1 "MCAL_layer/i2c/../../MCAL_Layer/gpio/gpio_cfg.h" 1
# 15 "MCAL_layer/i2c/../../MCAL_Layer/gpio/gpio.h" 2
...
# 56 "MCAL_layer/i2c/../../MCAL_Layer/gpio/gpio.h"
...
static void (*I2C_Report_Write_Collision_InterruptHandler)(void) = (0);
static void (*I2C_Report_Receive_Overflow_InterruptHandle)(void) = (0);
static void (*I2C_DefaultInterruptHandle_Req)(void) = (0);
static void (*I2C_DefaultInterruptHandle_Rec)(void) = (0);
...
static __attribute__((inline)) void MSSP_I2C_Interrupt_Configurations();
...
void HAL_I2C_setClock(uint32 clock){
    ...
    SSPADD = (uint8)(((16000000 / 4.0) / clock) - 1);
}
...
uint8 HAL_I2C_Write(uint8 i2c_data){
    uint8 ack = 1;
    if(i2c_mode == 1) {ack = HAL_I2C_Master_Write(i2c_data);}
    else if (i2c_mode == 0){HAL_I2C_Slave_Write(i2c_data);}
    return ack;
}
uint8 HAL_I2C_Print(uint8 *i2c_data){
    uint8 ack = 1;
...
uint8 HAL_I2C_Read(uint8 ack){
    uint8 i2c_data = 0;
    if(i2c_mode == 1) {i2c_data = HAL_I2C_Master_Read(ack);}
    else if (i2c_mode == 0){i2c_data = HAL_I2C_Slave_Read();}
    return i2c_data;
}
uint8 HAL_I2C_available(){
    (PIR1bits.SSPIF = 0);
