...
# 1 "MCAL_layer/adc/../../MCAL_Layer/gpio/gpio.h" 1
# 14 "MCAL_layer/adc/../../MCAL_Layer/gpio/gpio.h"
# 1 "MCAL_layer/adc/../../MCAL_Layer/gpio/../../MCAL_layer/device_config.h" 1
# 14 "MCAL_layer/adc/../../MCAL_Layer/gpio/gpio.h" 2

# 1 "MCAL_layer/adc/../../MCAL_Layer/gpio/gpio_cfg.h" 1
# 15 "MCAL_layer/adc/../../MCAL_Layer/gpio/gpio.h" 2
...
# 56 "MCAL_layer/adc/../../MCAL_Layer/gpio/gpio.h"
...
static void (*ADC_InterruptHandler)(void) = (0);
...
static __attribute__((inline)) void select_result_format(uint8 result_format);
static __attribute__((inline)) void set_conversion_clock();
# 36 "MCAL_layer/adc/hal_adc.c"
void HAL_ADC_Init(ADC_Config config,void (*InterruptHandler)(void)){
    ...
    select_result_format(0x01U);

    (ADCON0bits.ADON = 1);

}
# 68 "MCAL_layer/adc/hal_adc.c"
void HAL_ADC_DeInit()
{
...
# 106 "MCAL_layer/adc/hal_adc.c"
void HAL_ADC_StartConversion()
{
        (ADCON0bits.GO_DONE = 1);
}
# 125 "MCAL_layer/adc/hal_adc.c"
uint8 HAL_ADC_IsConversionDone()
{

        uint8 conversion_status = (uint8)((ADCON0bits.GO_DONE));
...
{
    switch(channel){
        case ADC_CHANNEL_AN0 : (TRISA |= (1 << 0)); break;
        case ADC_CHANNEL_AN1 : (TRISA |= (1 << 1)); break;
        case ADC_CHANNEL_AN2 : (TRISA |= (1 << 2)); break;
        case ADC_CHANNEL_AN3 : (TRISA |= (1 << 3)); break;
        case ADC_CHANNEL_AN4 : (TRISA |= (1 << 5)); break;
        case ADC_CHANNEL_AN5 : (TRISE |= (1 << 0)); break;
        case ADC_CHANNEL_AN6 : (TRISE |= (1 << 1)); break;
        case ADC_CHANNEL_AN7 : (TRISE |= (1 << 2)); break;
        default : ;
    }
}
static __attribute__((inline)) void select_result_format(uint8 result_format)
...
static __attribute__((inline)) void set_conversion_clock()
{
    ...
    if (16000000 <= (1.25*1000000)){{ADCS0 = ADC_CONVERSION_CLOCK_FOSC_DIV_2 & 0x01;ADCS1 = ADC_CONVERSION_CLOCK_FOSC_DIV_2 & 0x02;ADCS2 = ADC_CONVERSION_CLOCK_FOSC_DIV_2 & 0x04;};}
    else if(16000000 <= (2.5*1000000)) {{ADCS0 = ADC_CONVERSION_CLOCK_FOSC_DIV_4 & 0x01;ADCS1 = ADC_CONVERSION_CLOCK_FOSC_DIV_4 & 0x02;ADCS2 = ADC_CONVERSION_CLOCK_FOSC_DIV_4 & 0x04;};}
    else if(16000000 <= (5*1000000)) {{ADCS0 = ADC_CONVERSION_CLOCK_FOSC_DIV_8 & 0x01;ADCS1 = ADC_CONVERSION_CLOCK_FOSC_DIV_8 & 0x02;ADCS2 = ADC_CONVERSION_CLOCK_FOSC_DIV_8 & 0x04;};}
    else if(16000000 <= (10*1000000)) {{ADCS0 = ADC_CONVERSION_CLOCK_FOSC_DIV_16 & 0x01;ADCS1 = ADC_CONVERSION_CLOCK_FOSC_DIV_16 & 0x02;ADCS2 = ADC_CONVERSION_CLOCK_FOSC_DIV_16 & 0x04;};}
    else if(16000000 <= (20*1000000)) {{ADCS0 = ADC_CONVERSION_CLOCK_FOSC_DIV_32 & 0x01;ADCS1 = ADC_CONVERSION_CLOCK_FOSC_DIV_32 & 0x02;ADCS2 = ADC_CONVERSION_CLOCK_FOSC_DIV_32 & 0x04;};}
    else{}
}
