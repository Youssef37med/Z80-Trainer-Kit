...
# 1 "MCAL_layer/Interrupt/../../MCAL_Layer/gpio/gpio.h" 1
# 14 "MCAL_layer/Interrupt/../../MCAL_Layer/gpio/gpio.h"
# 1 "MCAL_layer/Interrupt/../../MCAL_Layer/gpio/../../MCAL_layer/device_config.h" 1
# 14 "MCAL_layer/Interrupt/../../MCAL_Layer/gpio/gpio.h" 2

# 1 "MCAL_layer/Interrupt/../../MCAL_Layer/gpio/gpio_cfg.h" 1
# 15 "MCAL_layer/Interrupt/../../MCAL_Layer/gpio/gpio.h" 2
...
# 56 "MCAL_layer/Interrupt/../../MCAL_Layer/gpio/gpio.h"
...
# 9 "MCAL_layer/Interrupt/mcal_external_interrupt.c" 2
    ...
    static InterruptHandler INT0_InterruptHandler = (0);




    static InterruptHandler RB4_InterruptHandler_HIGH = (0);
    static InterruptHandler RB4_InterruptHandler_LOW = (0);
    static InterruptHandler RB5_InterruptHandler_HIGH = (0);
    static InterruptHandler RB5_InterruptHandler_LOW = (0);
    static InterruptHandler RB6_InterruptHandler_HIGH = (0);
    static InterruptHandler RB6_InterruptHandler_LOW = (0);
    static InterruptHandler RB7_InterruptHandler_HIGH = (0);
    static InterruptHandler RB7_InterruptHandler_LOW = (0);
...
# 139 "MCAL_layer/Interrupt/mcal_external_interrupt.c"
static std_ReturnType INT0_SetInterruptHandler(void (*InterruptHandler)(void)){
    std_ReturnType ret = (std_ReturnType) 0x00;
    if((0) == InterruptHandler){
...
static std_ReturnType RBx_SetInterruptHandler(interrupt_RBX_src pin,void (*InterruptHandler_high)(void),void (*InterruptHandler_low)(void)){
    std_ReturnType ret = (std_ReturnType) 0x00;
    if((0) == InterruptHandler_high && (0) == InterruptHandler_low){
        ret = (std_ReturnType) 0x00;
    }
    else{
...
static std_ReturnType Interrupt_INT0_Pin_Init(void (*InterruptHandler)(void),interrupt_INTx_edge edge){
    ...
    if((0) == InterruptHandler){
        ret = (std_ReturnType) 0x00;
            ...
            (INTCONbits.INTE = 0);
            (INTCONbits.INTF = 0);
            if(FALLING==edge){(OPTION_REGbits.INTEDG = 0);}
            else if(RISING==edge){(OPTION_REGbits.INTEDG = 1);}
